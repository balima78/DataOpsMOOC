...
Na _wikipédia_ podemos encontrar como [definição de _DataOps_](https://en.wikipedia.org/wiki/DataOps), algo como:   
...
Utilizando ferramentas como R, Git e Quarto, os participantes no curso aprenderão a optimizar o desenvolvimento, a análise e a documentação de dados, garantindo reprodutibilidade, rastreamento de versões e automação dos fluxos de trabalho.
