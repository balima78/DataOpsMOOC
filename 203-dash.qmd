...
Neste projecto temos como objectivo construir um *dashboard* para descrevermos o Índice de Preços da Habitação (IPC) a partir dos dados obtidos no portal do INE.
...
+ Isolar funcionalidades: num *branch* podemos trabalhar numa nove funcionalidade corrigir *bugs* ou experimentar sem interferir com o código principal (geralmente o *branch main* ou *master*);
